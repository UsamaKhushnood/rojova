<template>
  <div>
    ...
    >
      <div class="row">
        <div class="col-md-12">
          <div class="box-header with-border">
            <h3 class="box-title">Select Shop Type</h3>
          </div>
        </div>
      </div>
      <br />
      <div class="row">
        <div
          v-for="(item,index) in ALLSERVIESANDSUBSERVICES"
          :key="index+item.name"
          class="col-md-3"
        >
          <label class>
            <iradio
              v-model="serviceID"
              name="shopType"
              v-bind:ClearSubServices="clearSubServices"
              :setValue="item.id"
            ></iradio>
            &nbsp;&nbsp; {{item.name}}
          </label>
      ...
      <template v-if="validation.hasError('serviceID')">
        <div class="text-danger">{{ validation.firstError('serviceID') }}</div>
      </template>
    </div>
    <div
    ...
    >
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <input type="text" placeholder="Distance" class="form-control input-sm" />
        </div>

        <div class="col-md-3">
          <label for="">Price Each Person</label>
          <select class="form-control" >
            <option selected  value>P.p 5,00 &euro;</option>
            <option   value>P.p 7,00 &euro;</option> 
            <option   value>P.p 10,00 &euro;</option>  
            <option   value>P.p 15,00 &euro;</option>
            <option   value>P.p 20,00 &euro;</option>
            <option   value>P.p 25,00 &euro;</option>
            <option   value>P.p 30,00 &euro;</option>
            <option   value>P.p 35,00 &euro;</option>
            <option   value>P.p 40,00 &euro;</option>
            <option   value>P.p 45,00 &euro;</option>
            <option   value>P.p 50,00 &euro;</option>
            <option   value>P.p 55,00 &euro;</option>
            <option   value>P.p 60,00 &euro;</option>
          </select>
        </div>

        <div class="col-md-2" style="padding-right: 0px;">
          <label >Person</label>
          <input type="text" placeholder="Person" class="form-control input-sm" />
        </div>
          <div class="col-md-1" 
        ...
        <!-- <div class="col-md-8">
          <div v-for="(item,index) in ALLRESERVEDFOOD" :key="index+item.name" class="col-md-4">
            <label class="">
              <icheck v-model="shopReservedFoodType" v-bind:removeReserveFoodType="removeReserveFoodType" v-bind:addReserveFoodType="addReserveFoodType" name="shopReservedFoodType" :setValue="item.id"></icheck>
              &nbsp;&nbsp;{{item.name}} 
            </label>  
          </div>  
      ...
      <template v-if="validation.hasError('shopReservedFoodType')">
        <div class="text-danger">{{ validation.firstError('shopReservedFoodType') }}</div>
      </template>
      <div class="col-sm-2"></div>
    </div>
