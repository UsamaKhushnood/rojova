    ...
    >
      <div class="modal-body" id="input-mask">
        <form method="post">
		   ...
		   <div class="input-group col-xs-12 align-items-center mt-4">
              <label class="col-sm-4 control-label mt-0" style="font-size:15px">Banner</label>
				<div class="col-sm-7 controls">
				 <img src="@/assets/img/BILLY-ARGEL-GINGA.jpg" alt="img" width="150px">
