      ...
      <div class="form-tab-widget">
          ...
          <ul class="nav nav-tabs wizard tab-4" role="tablist">
            <li role="presentation" :class="formStep==1?'active':''+formStep>1?'completed':''">
              <a href="#" @click.prevent="formStep=1">
                <span class="nmbr">0</span> Create New Shop
              </a>
            </li>
            ...
            <li role="presentation" :class="formStep==4?'active':''+formStep>4?'completed':''">
              <a href="#" @click.prevent="formStep=4">
                <span class="nmbr">3</span>Shop Owner
              </a>
            </li>
            <!--  <li role="presentation" :class="formStep==5?'active':''+formStep>5?'completed':''">
              <a href="#" @click.prevent="formStep=5">
                <span class="nmbr">4</span>Delivery Area
              </a>
            </li>-->
          </ul>
        </div>
        <div class="tab-content">
          <div :class="formStep==1?'active tab-pane':'tab-pane'" role="tabpanel">
            <AddClient @stepChange="FormStepChange"></AddClient>
          </div>
          <div :class="formStep==2?'active tab-pane':'tab-pane'" role="tabpanel">
            <ShopDetail @stepChange="FormStepChange"></ShopDetail>
          </div>
...
import ShopDetail from "@/components/add-shop/ShopDetail";
