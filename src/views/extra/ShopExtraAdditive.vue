      ...
      <div class="box-body">
        <div class="text-right" style="margin-bottom: 20px;">
          <BsModal
            ...
            >
            <template #button>
              <span class="btn btn-info btn-table">Add Additive</span>
            </template>
            <template #title>Additive</template>
            <div class="">
            ...
            <template #footer>
              <button type="button" class="btn btn-primary" :disabled="disableAddBtn" @click.prevent="addAdditive('submit')">
               <i class="fa fa-spinner fa-spin" v-if="disableAddBtn"></i> Add Additive
              </button>
            </template>
          </BsModal>
        </div>
        ...
        <div class="">
          ...
          <DataTable v-else :has_data="datas.length>0">
            ...
            <template #footer>
              <button type="button" class="btn btn-primary" :disabled="disableAddBtn" @click.prevent="addAdditive('update',data.id)">
               <i class="fa fa-spinner fa-spin" v-if="disableAddBtn"></i> Add Additive
              </button>
            </template>
          </BsModal>
...
export default {
  ...
  methods: {
    getAdditives : function(){
        var url = process.env.VUE_APP_API_BASE_URL+'additive/list';
    ...
    getPayLoad(type,id){
     ...
     addAdditive : function (type='submit',id='') {

        this.errors = {};
        var url = process.env.VUE_APP_API_BASE_URL+'additive/'+this.getURI(type);
     ...
     removeData (dataId) {
        ...
        var url = process.env.VUE_APP_API_BASE_URL+'additive/delete';
