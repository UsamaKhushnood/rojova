        ...
        <b-card no-body class="p-3">
          <b-card-text>
            ...
            >
              ...
              <div class="addVideo">
                <button class="btn btn-success" v-b-modal="'add-office-modal'">Add Office</button>
                <AddOfficeModal></AddOfficeModal>
              </div>
            </div>
            <!-- <div class="thumbnail repeater-thumbnail">
              <img src="@/assets/img/BILLY-ARGEL-GINGA.jpg" style="width: 100px; height: 90px" />
              ...
              <div class="col-x-12" style="background-color: #ddd">title</div>
            </div> -->
...
<script>
import AddOfficeModal from "@/components/modals/payment-offices-modals/AddOfficeModal"
export default {
  components: { AddOfficeModal },
  data(){
    return {
      rows: 20,
        perPage: 5,
