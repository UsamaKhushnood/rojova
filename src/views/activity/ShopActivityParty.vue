        ...
        <div class="box-body">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href=".ShopActivityPartyDeliverTab" data-toggle="tab"><b>Current Party Service</b></a></li>
              <li><a href=".ShopActivityPartyDinnerTab" data-toggle="tab"><b>Cancled Party Service</b></a></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane ShopActivityPartyDeliverTab active">
                  ...
                  <tr v-for="(data, index) in current" :key="index">
                    ...
                    <td>
                      ...
                      <BsModal
                        ...
                        <template #title>Cancle Party Service</template>
                        <div class="">
                          <div class="form-group">
                            <label>Are u sure to remove the Party Service? Please Select the reason</label>
              ...
              <div class="tab-pane ShopActivityPartyDinnerTab">
