        ...
        <div class="box-body">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href=".ShopActivityOrderDeliverTab" data-toggle="tab"><b>Current Orders</b></a></li>
              <li><a href=".ShopActivityOrderDinnerTab" data-toggle="tab"><b>Cancled Orders</b></a></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane ShopActivityOrderDeliverTab active">
                  ...
                  <tr v-for="(data, index) in current" :key="index">
                    ...
                    <td>
                      ...
                      <BsModal
                        ...
                        <template #title>Cancle Order</template>
                        <div class="">
                          <div class="form-group">
                            <label>Are u sure to remove the Order? Please Select the reason</label>
              ...
              <div class="tab-pane ShopActivityOrderDinnerTab">
