        ...
        <div class="box-body">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href=".DinnerOrderCurrentTab" data-toggle="tab"><b>Current Orders</b></a></li>
              <li><a href=".DinnerOrderCancledTab" data-toggle="tab"><b>Cancled Orders</b></a></li>
              <li><a href=".DinnerOrderAllTab" data-toggle="tab"><b>All Orders</b></a></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane DinnerOrderCurrentTab active">
              ...
              <div class="tab-pane DinnerOrderCancledTab">
              ...
              <div class="tab-pane DinnerOrderAllTab">
