  ...
  <section class="content">
    <div class="box">
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="info-box" style="background: #ecf0f5;">
              ...
              <div class="info-box-content">
                <span class="info-box-text">TOTAL STEMPCARDS</span>
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="info-box" style="background: #ecf0f5;">
              ...
              <div class="info-box-content">
                <span class="info-box-text">STEMPCARDS ACTIVE</span>
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="info-box" style="background: #ecf0f5;">
              ...
              <div class="info-box-content" >
                <span class="info-box-text">STEMPCARDS ON HOLD</span>
        ...
        <!-- Data Table -->
        <div class="tab-pane ShopOfferStempcardNewTab active">
          <DataTable :has_data="combinedDatas.length>0">
            <template #header>
              <th class="id-column">Card ID</th>
              <th>Card Title</th>
              <th>Shop Name</th>
              <th>Start Date</th>
              <th>End Date</th>
