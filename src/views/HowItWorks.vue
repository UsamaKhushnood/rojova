        ...
        <b-card no-body class="p-3">
          <b-card-text>
            ...
            >
              ...
              <div class="addVideo">
                <button class="btn btn-success" v-b-modal="'add-how-it-works-video-modal'">Add Video</button>
...
<script>
import AddVideoModal from "@/components/modals/how-it-works-modals/AddVideoModal"
export default {
