      ...
      <div class="box-body">
        <div class="nav-tabs-custom" style="margin-top: 30px;">
          <ul class="nav nav-tabs">
            <li class="active"><a href=".SettingsMenuImagesCategory" data-toggle="tab"><b>Menu Category</b></a></li>
            <li><a href=".SettingsMenuImagesCardItem" data-toggle="tab"><b>Menu Card Item</b></a></li>
            <li><a href=".SettingsMenuImagesItemType" data-toggle="tab"><b>Card Item Type</b></a></li>
            <li><a href=".SettingsMenuImagesBanner" data-toggle="tab"><b>Menu Banner</b></a></li>
          </ul>
