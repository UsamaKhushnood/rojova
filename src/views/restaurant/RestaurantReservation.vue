      ...
      <div class="box-body">
        ...
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            <li class="active"><a href=".RestaurantReservationCurrentTab" data-toggle="tab"><b>Current Reservations</b></a></li>
            <li><a href=".RestaurantReservationOnHoldTab" data-toggle="tab"><b>On Hold Reservations</b></a></li>
            <li><a href=".RestaurantReservationDeniedTab" data-toggle="tab"><b>Denied Reservations</b></a></li>
          </ul>
          <div class="tab-content">
            <div class="tab-pane RestaurantReservationCurrentTab active">
              <DataTable :has_data="current.length>0">
                ...
                <tr v-for="(data, index) in current" :key="index">
                  ...
                  <td>
                    ...
                    <a href="#" class="btn btn-danger btn-table"><i class="fa fa-close"></i></a>
                  </td>
                </tr>
              </DataTable>
            </div>
            <div class="tab-pane RestaurantReservationOnHoldTab">
            ...
            <div class="tab-pane RestaurantReservationDeniedTab">
