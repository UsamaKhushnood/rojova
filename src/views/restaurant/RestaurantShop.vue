...
<div class="Request">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Manage Resturents</li>
    </ol>
  </section>
...
import AddShopFormS2 from '@/components/extra/AddShopFormS2.vue'
...
export default {
  name: 'ResturentsShop',
  components: {
    DataTable, BsModal, VclTable,ShopNameDetails,AddShopFormS2
  },
  data(){
    return{
      active : '',
